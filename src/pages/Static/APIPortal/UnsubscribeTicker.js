...
class UnsubscribeTicker extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        <h2> UnsubscribeTicker </h2>
                        <h5> No authentication required </h5>
                        <p> Unsubscribes a user from a Ticker Market Data Feed </p>
                    </div>
                    <div className={`col-md-12`}>
                        <h4> Request </h4>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> SubscribeAccountEvents, SubscribeLevel1, SubscribeLevel2, SubscribeTicker, SubscribeTrades, UnsubscribeLevel1, UnsubscribeLevel2, UnsubscribeTrades </p>
                    </div>
                </div>
...
export default UnsubscribeTicker;