...
class UnsubscribeLevel2 extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
        ...
        return (
            <div>
                <div className={`row`}>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    <tr>
                                        <td> OMSId </td>
                                        <td>   
                                            <div><strong>integer.</strong>The ID of the Order Management System on which the user has subscribed to a Level 2 market data feed.</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> InstrumentId </td>
                                        <td>   
                                            <div><strong>long integer.</strong> The ID of the instrument being tracked by the Level 2 market data feed.</div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> SubscribeAccountEvents, SubscribeLevel1, SubscribeLevel2, SubscribeTicker, SubscribeTrades, UnsubscribeLevel1, UnsubscribeTicker, UnsubscribeTrades </p>
                    </div>
                </div>
...
export default UnsubscribeLevel2;