            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        ...
                        <p> Retrieves the details about a specific product on the trading venue. A product is an asset that is tradable or paid out. See “Products and Instruments” on page 4 for more information about the difference between these two items. </p>
                    </div>
                    <div className={`col-md-12`}>
                        <h4> Request </h4>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    <tr>
                                        <td> OMSId </td>
                                        <td>   
                                            <div><strong>Integer.</strong> The ID of the Order Management System that includes the product. </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> ProductId </td>
                                        <td>   
                                            <div><strong>long integer.</strong> The ID of the product (often a currency) on the specified Order Management System. </div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> GetAccountPositions, GetInstrument, GetInstruments, GetProducts </p>
                    </div>
                </div>
