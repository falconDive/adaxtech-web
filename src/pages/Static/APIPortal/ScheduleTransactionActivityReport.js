...
class ScheduleTransactionActivityReport extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        <h2> ScheduleTransactionActivityReport </h2>
                        <p> Schedules a series of transaction activity reports for a list of accounts on a single Order Management System, starting at a specific date/time, and covering a specific time interval (90 days, for example). The reports will run periodically until canceled. </p>
                        <p> Transaction Activity Reports are delivered in comma-separated-value (CSV) format. For specific CSV formatting information, see the APEX Extract CSV Data Dictionary, available from ADAX Tech. </p>
                    </div>
                    <div className={`col-md-12`}>
                        <h4> Request </h4>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> GenerateTradeActivityReport, GenerateTransactionActivityReport, GenerateTreasuryActivityReport, GetUserReportTickets, GetUserReportWriterResultRecords, ScheduleTradeActivityReport, ScheduleTreasuryActivityReport. </p>
                    </div>
                </div>
...
export default ScheduleTransactionActivityReport;