...
class UnsubscribeTrades extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        <h2> UnsubscribeTrades </h2>
                        <h5> No authentication required </h5>
                        <p> Unsubscribes a user from the Trades Market Data Feed </p>
                    </div>
                    <div className={`col-md-12`}>
                        <h4> Request </h4>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    <tr>
                                        <td> OMSId </td>
                                        <td>   
                                            <div><strong>integer.</strong> The ID of the Order Management System on which the user has subscribed to a trades market data feed.</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> InstrumentId </td>
                                        <td>   
                                            <div><strong>long integer.</strong>The ID of the instrument being tracked by the trades market data feed.</div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> SubscribeAccountEvents, SubscribeLevel1, SubscribeLevel2, SubscribeTicker, SubscribeTrades, UnsubscribeLevel1, UnsubscribeLevel2, UnsubscribeTicker </p>
                    </div>
                </div>
...
export default UnsubscribeTrades;