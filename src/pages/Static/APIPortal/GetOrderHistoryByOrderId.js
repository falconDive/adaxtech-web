...
class GetOrderHistoryByOrderId extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        <h2> GetOrderHistoryByOrderId </h2>
                        <p> Retrieves the full order history of a specific order by its order ID, including any changes.  </p>
                    </div>
                    <div className={`col-md-12`}>
                        <h4> Request </h4>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> OrderId </td>
                                        <td>   
                                            <div><strong>integer.</strong> The ID of the order on the Order Management System. </div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> CancelAllOrders, CancelOrder, CancelReplaceOrder, GetOpenOrders, GetOpenQuotes, GetOrderHistory, GetOrdersHistory, GetOrderStatus, ModifyOrder, SendOrder </p>
                    </div>
                </div>
...
export default GetOrderHistoryByOrderId;