...
class ScheduleTradeActivityReport extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        <h2> ScheduleTradeActivityReport </h2>
                        <p> Schedules a series of trade activity reports to run for a list of accounts on a single Order Management System, starting at a specific date/time, and covering a specific time duration. The reports will run periodically until canceled. </p>
                        <p> Trade Activity Reports are delivered in comma-separated-value (CSV) format. For specific CSV formatting information, see the APEX Extract CSV Data Dictionary, available from ADAX Tech. </p>
                    </div>
                    <div className={`col-md-12`}>
                        <h4> Request </h4>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    <tr>
                                        <td> AccountIdList </td>
                                        <td>   
                                            <div><strong>integer array.</strong> Comma-separated integers; each element an account ID on the Order Management System whose trade activity will be reported on. All accounts must be from the same OMS and be associated with the logged-in user.</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> OMSId </td>
                                    ...
                                    <tr>
                                        <td> beginTime </td>
                                        <td>   
                                            <div><strong>string.</strong> The time from which the trade activities will be reported, in ISO 8601 format and UTC time zone. See “Time– and Date-Stamp Formats” on page 8.</div>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div className={`col-md-12`}>
                        <h4> Response </h4>
                        <p>The response returns an object confirming the settings in the call. </p>
                        <div className={`codeCont`}>
                            <div>{"{"}</div>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> GenerateTradeActivityReport, GenerateTransactionActivityReport, GenerateTreasuryActivityReport, GetUserReportTickets, GetUserReportWriterResultRecords, ScheduleTreasuryActivityReport, ScheduleTreasuryActivityReport </p>
                    </div>
                </div>
...
export default ScheduleTradeActivityReport;