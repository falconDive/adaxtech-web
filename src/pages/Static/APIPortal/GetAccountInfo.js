...
class GetAccountInfo extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        ...
                        <p> Returns detailed information about one specific account belonging to the authenticated user and existing on a specific Order Management System. </p>
                    </div>
                    <div className={`col-md-12`}>
                        <h4> Request </h4>
                        <div className={`codeCont`}>
                            ...
                            <div style={{paddingLeft:'10px'}}>{"“AccountHandle”: 0,"}</div>
                            <div>{"}"}</div>
                        </div>
                        <p> Where: </p>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    <tr>
                                        <td> OMSId </td>
                                        <td>   
                                            <div><strong>integer.</strong> The ID of the Order Management System on which the account exists.</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> AccountId </td>
                                        <td>   
                                            <div><strong>integer.</strong> The ID of the account on the Order Management System for which information will be returned.</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> AccountHandle </td>
                                        <td>   
                                            <div><strong>string.</strong>  AccountHandle is a unique user-assigned name that is checked at create time by the Order Management System. Alternate to Account ID. </div>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> AccountHandle </td>
                                        <td>   
                                            <div><strong>string.</strong> AccountHandle is a unique user-assigned name that is checked at create time by the Order Management System to assure its uniqueness. </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> FirmId </td>
                                        <td>   
                                            <div><strong>string.</strong> An arbitrary identifier assigned by a trading venue operator to a trading firm as part of the initial company, user, and account set up process. For example, Smith Financial Partners might have the ID SMFP. </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> FirmName </td>
                                    ...
                                    <tr>
                                        <td> FeeProduct </td>
                                        <td>   
                                            <div><strong>integer.</strong> The ID of the preferred fee product, if any. Defaults to 0. </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> RefererId </td>
                                        <td>   
                                            <div><strong>integer.</strong> Captures the ID of the person who referred this account to the trading venue, usually for marketing purposes. </div>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> GetUserAccounts, GetUserAccountInfos, SubscribeAccountEvents</p>
                    </div>
                </div>
