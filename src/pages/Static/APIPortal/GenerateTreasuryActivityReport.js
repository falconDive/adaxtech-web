...
class GenerateTreasuryActivityReport extends Component {
    constructor (props) {
        super(props)
        this.state = {
          showAlert: false,
            ...
            <div>
                <div className={`row`}>
                    <div className={`col-md-12`}>
                        <h2> GenerateTreasuryActivityReport </h2>
                        <p> Generates an immediate report on all company treasury activities related to the trading venue — withdrawals, transfers, and funds movements unrelated to trading — over a specified period. A logged-in and authenticated user can only generate a transaction activity report for accounts associated with the user. There can be multiple users associated with an account; see “Permissions” on page 4. </p>
                            ...
                            <table className={`table backgroundInfoTbl`}>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> startTime </td>
                                        <td>   
                                            <div><strong>string.</strong> startTime identifies the time and date for the historic beginning of the trade activity report in ISO 8601 format and UTC time zone. See “Time– and Date-Stamp Formats” on page 8. </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td> endTime </td>
                    ...
                    <div className={`col-md-12`}>
                        <h4> See Also </h4>
                        <p> GenerateTradeActivityReport, GenerateTransactionActivityReport, GetUserReportTickets, ScheduleTradeActivityReport, GenerateTreasuryActivityReport, and ScheduleTreasuryActivityReport </p>
                    </div>
                </div>
...
export default GenerateTreasuryActivityReport;