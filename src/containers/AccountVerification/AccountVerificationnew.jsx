...
class AccountVerification extends Component {
	...
	render() {
		...
		const { match, AccountInfo } = this.props;
					...
					<Formik
						...
						onSubmit={(values, actions) => {
							...
							setTimeout(() => {
								...
								values['account_id'] = this.props.AccountInfo.Data.AccountId;
								values['email'] = this.props.UserConfigData.Data.Email;
								formData.append('man', values.account_id);
								formData.append('user_id', values.user_id);
								formData.append('bfn', values.first_name);
								formData.append('bln', values.last_name);
								formData.append('middle_name', values.middle_name);
								formData.append('dob', values.date_of_birthHandle);
								formData.append('bsn', values.street_address);
								formData.append('bco', values.country_address);
								formData.append('bz', values.postal_code);
								formData.append('bc', values.city);
								formData.append('bs', values.province_address);
								formData.append('pm', values.telephone_number);
								formData.append('email', values.email);
								formData.append('docType', values.id_document);
								formData.append('docCountry', values.country_address);
								formData.append('file', values.file);

								axios({
									method: 'POST',
									url: `${SERVER_URL}/api/kyc/submit-adax`,
									headers: {
													...
													<HBFormGroup>
														...
														<DateInput
															...
															onChange={(event, { name, value }) => {
																setFieldValue(`date_of_birthHandle`, value);
																if (value) {
														...
														{/* <DayPickerInput
															...
															onDayChange={(day) => {
																setFieldValue(`date_of_birthHandle`, day);
